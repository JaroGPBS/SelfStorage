...
# Usuń krytyczne style custom splashu z <head>.
s = re.sub(
    r'\n    #startupSplash \{.*?\n    \.toast \{',
    '\n    .toast {',
    s,
...
# Usuń skrypt wymuszający ~2 sekundy splashu.
s = re.sub(
...
# Domyślny tekst przycisku na ekranie operacji.
s = s.replace(
...
# 3) operation-flow.js — banalna etykieta: Wróć / Cofnij.
